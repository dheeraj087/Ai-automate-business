    ...
    return (
        <div className="w-full lg:flex flex-col  lg:w-[80%] lg:m-auto text-white">
            ...
            ">
                ...
                <div className="">
                    <button className="border cursor-pointer hover:scale-102 active:scale-98 active:bg-[#c1c1c1] border-[#5a5a5a] bg-[#cd2f2f] text-white shadow-[inset_3px_4px_10px_black] font-bold  p-2 mt-7 ml-4 rounded">Start free trial</button>

                    <button className="border cursor-pointer hover:scale-102 active:scale-98 active:bg-[#c1c1c1] not-first: border-[#5a5a5a] bg-[#468950] text-white shadow-[inset_3px_4px_10px_black] font-bold  p-2 mt-7 ml-4 rounded">Get started</button>
                </div>
